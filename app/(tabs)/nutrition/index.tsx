...
const styles = StyleSheet.create({
  ...
  arrowText: { color: colors.brand.primary, fontSize: typography['2xl'], fontFamily: fonts.bold },
  arrowDisabled: { color: colors.text.muted },
  dateLabel: { color: colors.text.primary, fontSize: typography.xl, fontFamily: fonts.bold, minWidth: 120, textAlign: 'center' },
  ...
  burnBannerText: { color: colors.warning, fontSize: typography.sm, fontFamily: fonts.semibold },
  dimmed: { opacity: 0.4 },
